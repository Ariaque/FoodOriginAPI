    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests().antMatchers("/auth/**",
                        "/reset/resetPassword/sendEmail",
                        "/reset/resetPassword/validateToken",
                        "/reset/resetPassword/savePassword",
                        "/typeDenree/**",
                        "/origineDenree/**",
                        "/urlVideo/**",
                        "/label/**",
                        ...
                        "/transformateur/**",
                        "/typeTransformateur/**",
                        "/infoTransformateur/transformateur/**",
                        "/certification/**",
                        "/contact/**",
                        "/user/activation/**",
                        "/user/isActive/**",
