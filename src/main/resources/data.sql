...
INSERT INTO foodOrigin_user (username, password, numero_telephone, is_activated, fk_role) VALUES ('admin', 'admin', '0749314243', true, 1) ON DUPLICATE KEY UPDATE username = 'admin';
